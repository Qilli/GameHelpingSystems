...
namespace Base.CommonCode.Console
{
    /// <summary>
    ...
    class Console : MonoBehaviour
    {
        ...
        readonly Dictionary<UnityEngine.LogType, bool> logTypeFilters = new Dictionary<UnityEngine.LogType, bool>
        {
            {  UnityEngine.LogType.Assert, true },
            { UnityEngine.LogType.Error, true },
            { UnityEngine.LogType.Exception, true },
            { UnityEngine.LogType.Log, true },
            { UnityEngine.LogType.Warning, true },
        };
        ...
        void DrawToolbar()
        {
            ...
            foreach (UnityEngine.LogType logType in Enum.GetValues(typeof(UnityEngine.LogType)))
            {
        ...
        void HandleLogThreaded(string message, string stackTrace, UnityEngine.LogType type)
        {
            var log = new Log
            {
                count = 1,
